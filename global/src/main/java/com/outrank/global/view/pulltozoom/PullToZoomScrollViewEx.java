...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
        ...
        ((InternalScrollView) mRootView).setOnScrollViewChangedListener(new OnScrollViewChangedListener() {
            ...
            public void onInternalScrollChanged(int left, int top, int oldLeft, int oldTop) {
                if (mScrollChangedListener != null) {
                    mScrollChangedListener.onScrollChanged(left, top, oldLeft, oldTop);
                }
    ...
    public void addScrollChangedListener(ScrollChangedListener listener) {
     ...
     * @param scale
     */
    public void setCustomHeaderHeight(WindowManager manager, float scale) {
        DisplayMetrics localDisplayMetrics = new DisplayMetrics();
        manager.getDefaultDisplay().getMetrics(localDisplayMetrics);
        int mScreenHeight = localDisplayMetrics.heightPixels;
        int mScreenWidth = localDisplayMetrics.widthPixels;
        float scaleValue = scale > 1 ? 0.4f : scale;
        LinearLayout.LayoutParams localObject = new LinearLayout.LayoutParams(mScreenWidth, (int) (mScreenHeight * scaleValue));
