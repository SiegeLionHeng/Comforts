package com.outrank.global.view.pulltozoom;
...
public class PullToZoomRecyclerViewEx extends PullToZoomBase<RecyclerView> implements AbsListView.OnScrollListener {
        ...
        if (mHeaderContainer != null) {
            if (mRootView != null && mRootView.getAdapter() != null) {
                ...
                if (mAdapter != null) {
                    ...
                    RecyclerViewHeaderAdapter.ExtraItem<RecyclerView.ViewHolder> mExtraItem = new RecyclerViewHeaderAdapter.ExtraItem<RecyclerView.ViewHolder>(RecyclerViewHeaderAdapter.INT_TYPE_HEADER, new RecyclerView.ViewHolder(mHeaderContainer) {
                        @Override
    ...
    public void setAdapterAndLayoutManager(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, GridLayoutManager mLayoutManager) {
...
//        rv.setId(android.R.id.list);
    ...
    public void handleStyledAttributes(TypedArray a) {
        ...
        RecyclerViewHeaderAdapter<RecyclerView.ViewHolder> mAdapter = (RecyclerViewHeaderAdapter<RecyclerView.ViewHolder>) mRootView.getAdapter();
        if (mAdapter != null) {
            RecyclerViewHeaderAdapter.ExtraItem<RecyclerView.ViewHolder> mExtraItem = new RecyclerViewHeaderAdapter.ExtraItem<>(RecyclerViewHeaderAdapter.INT_TYPE_HEADER, new RecyclerView.ViewHolder(mHeaderContainer) {
                @Override
                public String toString() {
                    return super.toString();
                }
