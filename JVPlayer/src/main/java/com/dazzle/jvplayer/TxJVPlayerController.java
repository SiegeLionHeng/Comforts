 ...
 * 仿腾讯视频热点列表页播放器控制器.
 */
public class TxJVPlayerController
        extends JVPlayerController
    ...
    public TxJVPlayerController(Context context) {
        super(context);
        mContext = context;
        init();
    }
    ...
    public void setLenght(long length) {
        mLength.setText(JVUtil.formatTime(length));
    }
    ...
    protected void onPlayStateChanged(int playState) {
        switch (playState) {
            case JVPlayer.STATE_IDLE:
                break;
            case JVPlayer.STATE_PREPARING:
                ...
                break;
            case JVPlayer.STATE_PREPARED:
                startUpdateProgressTimer();
                break;
            case JVPlayer.STATE_PLAYING:
                mLoading.setVisibility(View.GONE);
                mRestartPause.setImageResource(R.drawable.ic_player_pause);
                startDismissTopBottomTimer();
                break;
            case JVPlayer.STATE_PAUSED:
                mLoading.setVisibility(View.GONE);
                mRestartPause.setImageResource(R.drawable.ic_player_start);
                cancelDismissTopBottomTimer();
                break;
            case JVPlayer.STATE_BUFFERING_PLAYING:
                mLoading.setVisibility(View.VISIBLE);
                mRestartPause.setImageResource(R.drawable.ic_player_pause);
                mLoadText.setText("正在缓冲...");
                startDismissTopBottomTimer();
                break;
            case JVPlayer.STATE_BUFFERING_PAUSED:
                mLoading.setVisibility(View.VISIBLE);
                mRestartPause.setImageResource(R.drawable.ic_player_start);
                mLoadText.setText("正在缓冲...");
                cancelDismissTopBottomTimer();
                break;
            case JVPlayer.STATE_ERROR:
                cancelUpdateProgressTimer();
                setTopBottomVisible(false);
                mTop.setVisibility(View.VISIBLE);
                mError.setVisibility(View.VISIBLE);
                break;
            case JVPlayer.STATE_COMPLETED:
                cancelUpdateProgressTimer();
                setTopBottomVisible(false);
    ...
    protected void onPlayModeChanged(int playMode) {
        switch (playMode) {
            case JVPlayer.MODE_NORMAL:
                ...
                break;
            case JVPlayer.MODE_FULL_SCREEN:
                ...
                break;
            case JVPlayer.MODE_TINY_WINDOW:
                mBack.setVisibility(View.VISIBLE);
                mClarity.setVisibility(View.GONE);
                break;
        }
    ...
    protected void updateProgress() {
        ...
        mPosition.setText(JVUtil.formatTime(position));
        mDuration.setText(JVUtil.formatTime(duration));
        // 更新时间
    ...
    protected void showChangePosition(long duration, int newPositionProgress) {
        ...
        mChangePositionCurrent.setText(JVUtil.formatTime(newPosition));
        mChangePositionProgress.setProgress(newPositionProgress);
        mSeek.setProgress(newPositionProgress);
        mPosition.setText(JVUtil.formatTime(newPosition));
    }
