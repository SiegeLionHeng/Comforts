 ...
 * Description:切换清晰度对话框（仿腾讯视频切换清晰度的对话框）.
 */
public class ChangeClarityDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        windowParams.width = JVUtil.getScreenHeight(context);
        windowParams.height = JVUtil.getScreenWidth(context);
    ...
    public void setClarityGrade(List<String> items, int defaultChecked) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            params.topMargin = (i == 0) ? 0 : JVUtil.dp2px(getContext(), 16f);
